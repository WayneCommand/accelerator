 ...
 */
package ltd.inmind.accelerator.security.config.annotation.web.configuration;

import ltd.inmind.accelerator.security.config.annotation.web.configurers.oauth2.server.authorization.OAuth2AuthorizationServerConfigurer;
