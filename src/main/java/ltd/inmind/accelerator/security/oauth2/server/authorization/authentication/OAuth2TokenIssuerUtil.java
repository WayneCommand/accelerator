...
import ltd.inmind.accelerator.security.oauth2.core.OAuth2RefreshToken2;
import ltd.inmind.accelerator.security.oauth2.jwt.JoseHeader;
import ltd.inmind.accelerator.security.oauth2.jwt.JwtClaimsSet;
...
class OAuth2TokenIssuerUtil {
	...
	static Jwt issueJwtAccessToken(JwtEncoder jwtEncoder, String subject, String audience, Set<String> scopes, Duration tokenTimeToLive) {
		...
		String issuer = "http://auth-service:9000";		// TODO Allow configuration for issuer claim
